...
- The `ArcMark Standard` badge in `README.md` mirrors the ArcMark document and XSD version. It changes only when the standard changes.
- The `Version` badge in `README.md` mirrors ArcMark Studio's `CFBundleShortVersionString`.
